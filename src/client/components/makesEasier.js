        ...
        <div className="relative">
            <div className="w-full md:h-[650px] md:mt-0 bg-no-repeat bg-cover bg-life-easier">
                <div className="relative inset-0 flex flex-col justify-center items-center text-white">
                    <h1 className="text-3xl md:text-2xl lg:text-4xl font-bold mt-4 md:mt-40 ml-10">We make your life easier.</h1>
                    <p className="text-lg md:text-base lg:text-lg ml-10"> Our diligent services make your life much easier and happier!</p>
